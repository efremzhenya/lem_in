...
size_t						parse_lines(t_line **lines, t_lemin **lemin,
										t_vertex **rooms);
int							parse_line(char *line, t_lemin **lemin,
										t_vertex **rooms);
char						*read_next_line();
...
int							is_room_dup(t_vertex **rooms, char *name,
										int x, int y);
...
** parse_room_type
*/
int							parse_room_type(char *line, t_lemin **lemin,
											t_vertex **rooms);
int							parse_room(char *line, t_lemin **lemin,
										t_vertex **rooms);
...
** list
*/
t_ilist						*new_ilist(size_t index, int weight,
										int is_blocked);
...
int							parse_link(char *line, t_lemin **lemin,
										t_vertex **rooms);

/*
** free
*/
void						free_all(t_lemin **lemin, t_line **lines,
									t_vertex **rooms);
...
int							add_path_room(t_path_room **path_rooms,
											t_path_room *path_room);
void						free_paths(t_path **paths);
int							push_path_room(t_path_room **path_rooms,
											t_path_room *path_room);
...
void						get_sorted_paths_lengths(size_t lens[],
									size_t path_count, t_path **paths,
										t_vertex **path_with_idexes);
void						calc_koefs(int koef[], size_t count,
										size_t lengths[]);
...
void						split_and_set_weight(t_path_room **path_rooms,
												t_lemin **lemin);
int							find_common_links(t_lemin **lemin, t_path *path,
												short int **matrix);
t_path						*create_new_path(t_lemin **lemin, t_path *path,
											short int **matrix, size_t index);
short int					combine_paths(t_lemin **lemin, t_path *path,
											short int **matrix);
...
**ants
*/
void						ants_go(t_lemin **lemin, t_vertex **paths,
									int ants, size_t i);
t_vertex					**indexing_paths(t_lemin **lemin,
											size_t i, size_t j);
void						ants_init(t_ant **ants, int count);
int							move_ants(t_lemin **lemin, t_ant **ants,
										t_vertex **paths, int i);
void						free_ants(t_lemin **lemin, t_ant **ants,
										t_vertex **paths);
